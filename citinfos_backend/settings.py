...
MIDDLEWARE = [
    ...
    # Check for suspended users (must be after authentication)
    'accounts.suspension_middleware.SuspensionCheckMiddleware',
...
LOGGING = {
    ...
    'root': {
        'handlers': ['console'],  # Use only console for Docker
        'level': 'INFO',
    },
    'loggers': {
        'django': {
