    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boundary_type', models.CharField(blank=True, choices=[('international', 'International Border'), ('state', 'State/Province Border'), ('regional', 'Regional Border'), ('municipal', 'Municipal Border'), ('district', 'District Border'), ('other', 'Other Administrative Border')], max_length=20)),
