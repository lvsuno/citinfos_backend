...
router.register(r'community-invitations', views.CommunityInvitationViewSet, basename='community-invitation')
router.register(r'community-join-requests', views.CommunityJoinRequestViewSet, basename='community-join-request')
